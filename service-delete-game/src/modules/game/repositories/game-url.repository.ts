...
export class GameUrlRepository {
  ...
  /**
   * Retrieve all game URLs from the database that are not soft deleted.
  ...
  /**
   * Find a game URL by its ID in the database (ignoring soft deleted).
   * @param gameUrlId The ID of the game URL.
   * @returns A Promise that resolves to the game URL object.
   */
